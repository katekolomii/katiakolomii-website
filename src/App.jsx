...
function App() {
  return (
    ...
    >
      ...
      <div id="copyright" style={{ position: "absolute", bottom: 20, left: "2.5%", zIndex: 10, fontFamily: "'DM Mono', monospace", fontSize: "11px", color: "rgba(0,0,0,0.4)", letterSpacing: "0.06em", pointerEvents: "none", whiteSpace: "nowrap" }}>© Copyright 2026 Kateryna Kolomiichenko</div>
    </AuroraBackground>
  )
}
